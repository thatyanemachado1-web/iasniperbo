...
PUBLISHER_INTERVAL="${PUBLISHER_INTERVAL:-0.25}"
...
export SNIPER_ADMIN_EMAIL SNIPER_ADMIN_PASSWORD SNIPER_ADMIN_TOKEN
export SNIPER_LOCAL_DASHBOARD_TOKEN="${SNIPER_LOCAL_DASHBOARD_TOKEN:-$SNIPER_ADMIN_TOKEN}"
