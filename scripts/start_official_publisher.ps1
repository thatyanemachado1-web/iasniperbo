...
$startInfo.Arguments = "scripts\official_dashboard_publisher.py --env-file `"$sourceEnvFile`" --local-url `"$localDashboardUrl`" --interval $interval --urgent-signal --log-file official_dashboard_publisher.log"
